...
(function () {
  ...
  var GAME_CONTENT = {
    'forbidden-word': {
      icon: '🚫',
      title: 'คำต้องห้าม',
      subtitle: 'คำต้องห้าม -- เดาคำของตัวเอง!',
      rules: [
    ...
    'word-link': {
      icon: '🔗',
      title: 'คำเชื่อม',
      subtitle: 'คำเชื่อม -- เชื่อมคำใบ้ไปยังคำของทีม!',
      rules: [
    ...
    'spy': {
      icon: '🕵️',
      title: 'สายลับ',
      subtitle: 'สายลับ -- หาตัวสายลับในกลุ่ม!',
      rules: [
    ...
    'werewolf': {
      icon: '🐺',
      title: 'หมาป่า',
      subtitle: 'หมาป่า -- รอดชีวิตข้ามคืน!',
      rules: [
    ...
    'knights': {
      icon: '⚔️',
      title: 'อัศวิน',
      subtitle: 'อัศวิน -- บทบาทลับ และภารกิจทีม!',
      rules: [
